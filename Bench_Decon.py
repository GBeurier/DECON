...
from tensorflow.keras.layers import Dense, Conv1D, Flatten, Dropout, Input, SpatialDropout1D, SeparableConv1D, BatchNormalization, MaxPool1D, Flatten, DepthwiseConv1D, MaxPooling1D, BatchNormalization, SeparableConv1D, Dropout
...
def main():
    ...
    for pproc in preprocessings_list:
        ...
        model, model_name = get_model(X_train)
